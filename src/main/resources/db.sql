...
CREATE TABLE `flow` (
  `id` varchar(20) NOT NULL,
  `flow_num` varchar(50) DEFAULT NULL COMMENT '流水号',
...
INSERT INTO `product` VALUES ('1', '苹果xs', '8699');
INSERT INTO `product` VALUES ('2', '华为荣耀', '4000');
INSERT INTO `product` VALUES ('3', '三星', '6999');